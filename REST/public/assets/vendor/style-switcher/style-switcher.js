var styleSwitcher = {
    ...
    initialize: function() {
        ...
        if (!this.initialized) {
            ...
            $.styleSwitcherCachedScript = function(a, b) {
                ...
                less = {
                    env: "development"
                }, $.styleSwitcherCachedScript("assets/vendor/less/less.js").done(function() {
    ...
    getCss: function() {
        raw = "", options = {
            indent: "	",
            autosemicolon: !0
        }, $("#getCSSModal").modal("show"), $("#getCSSTextarea").text($('style[id$="assets-vendor-style-switcher-less-skin"]').text()), raw = $("#getCSSTextarea").text(), $("#getCSSTextarea").text(cssbeautify(raw, options)), $("#getCSSTextareaExt").text($('style[id$="assets-vendor-style-switcher-less-extension"]').text()), raw = $("#getCSSTextareaExt").text(), $("#getCSSTextareaExt").text(cssbeautify(raw, options))
    },
