...
namespace RESTPROYECT
{
    ...
    public interface IPedidos
    {
        ...
        [OperationContract]
        [WebInvoke(Method = "GET", UriTemplate = "pedidos/{idCliente}", ResponseFormat = WebMessageFormat.Json)]
        //Pedido ObtenerPedido(string idCliente);
        List<Pedido> ListarAPedidos(string idCliente);
